<%@ Page Title="" Language="C#" MasterPageFile="~/Vistas/principal.Master" AutoEventWireup="true" CodeBehind="Registrar_Alumno.aspx.cs" Inherits="CapaPresentacionW.Vistas.Registrar_Alumno" %>
    ...
    <div class="container-contact100">
		<div class="wrap-contact100">
			...
			<div class="container-contact100-form-btn">
				...
				<div class="wrap-input100 validate-input bg1" data-validate="Ingrese su Codigo">
					<span class="label-input100">CodAlumno : *</span>
                    <asp:TextBox class="input100" type="text" ID="txtcodalumno" runat="server" placeholder="Ingrese su DNI"></asp:TextBox>
		...
		<div class="wrap-input100 input100-select bg1">
					...
					<div>
					    <asp:DropDownList class="js-select2"  ID="cboEscuela" runat="server" SelectionMode="Single" >
		...
		<div class="wrap-input100 input100-select bg1">
					<span class="label-input100">Periodo de Ingreso *</span>
					<div>
					    <asp:DropDownList class="js-select2"  ID="cboIngreso" runat="server" SelectionMode="Single" >
